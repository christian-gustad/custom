...
alias tte='emacs -nw --quick'
alias em="emacsclient --create-frame"
# Exa
alias l="exa --sort Name --icons"
alias ll="exa --sort Name --long --icons --git -h --no-user"
alias la="exa --sort Name --long --all --icons --git -h --no-user"
alias lr="exa --sort Name --long --recurse --icons --git -h --no-user"
alias lra="exa --sort Name --long --recurse --all --icons --git -h --no-user"
alias lt="exa --sort Name --long --tree --icons --git -h --no-user"
alias lta="exa --sort Name --long --tree --all --icons --git -h --no-user"
...
# Quickly go ba	ck to a specific parent directory.
Tarrasch/zsh-bd
